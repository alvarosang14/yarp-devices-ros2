...
HapticDevice_nws_ros2_ParamsParser::HapticDevice_nws_ros2_ParamsParser()
{
}


std::vector<std::string> HapticDevice_nws_ros2_ParamsParser::getListOfParams() const
{
...
bool HapticDevice_nws_ros2_ParamsParser::getParamValue(const std::string& paramName, std::string& paramValue) const
{
    if (paramName =="period")
    {
...
std::string HapticDevice_nws_ros2_ParamsParser::getConfiguration() const
{
...
bool      HapticDevice_nws_ros2_ParamsParser::parseParams(const yarp::os::Searchable & config)
{
    //Check for --help option
    if (config.check("help"))
    {
        yCInfo(HapticDevice_nws_ros2ParamsCOMPONENT) << getDocumentationOfDeviceParams();
    }
    ...
    //Parser of parameter period
    {
        if (config.check("period"))
        {
            ...
            yCInfo(HapticDevice_nws_ros2ParamsCOMPONENT) << "Parameter 'period' using value:" << m_period;
        }
        else
        {
            yCInfo(HapticDevice_nws_ros2ParamsCOMPONENT) << "Parameter 'period' using DEFAULT value:" << m_period;
        }
    ...
    //Parser of parameter node_name
    {
        if (config.check("node_name"))
        {
            ...
            yCInfo(HapticDevice_nws_ros2ParamsCOMPONENT) << "Parameter 'node_name' using value:" << m_node_name;
        }
        else
        {
    ...
    //Parser of parameter topic_name
    {
        if (config.check("topic_name"))
        {
            ...
            yCInfo(HapticDevice_nws_ros2ParamsCOMPONENT) << "Parameter 'topic_name' using value:" << m_topic_name;
        }
        else
        {
    ...
    if (prop_check.size() > 0)
    {
        ...
        for (auto it=prop_check.begin(); it!=prop_check.end(); it++)
        {
            ...
            {
                yCError(HapticDevice_nws_ros2ParamsCOMPONENT) << "User asking for parameter: "<<it->name <<" which is unknown to this parser!";
                extra_params_found = true;
            }
            else
            {
                yCWarning(HapticDevice_nws_ros2ParamsCOMPONENT) << "User asking for parameter: "<< it->name <<" which is unknown to this parser!";
            }
        }
...
std::string      HapticDevice_nws_ros2_ParamsParser::getDocumentationOfDeviceParams() const
{
    std::string doc;
    doc = doc + std::string("\n=============================================\n");
